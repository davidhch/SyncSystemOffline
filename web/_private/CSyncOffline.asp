...
Class CSyncOffline
	...
	Else	
		...
		End If
		' Request from Accounts : NewZapp is NEVER allowed to update billing details in OE 27/04/2009
	...
	Public Sub addAccountData(nNewZappCID,nOrderEntryCID,nWebHostingID,dRenewalDate,strUserName,strPassword,bActiveStatus,bDemoStatus,bUsedStatus,nCustomerProductID,nProductID,nYears,nOnlineID,nOfflineID,nTableID,bLocked,bExecuted)
		
		strMessage = "No message from addAccountData"

		objSyncLib.GetOfflineID nOnlineID,9,nOfflineID
			
		If objSyncLib.isInsert(CUSTOMERS_ID,nOfflineID,"number") Then
			nOfflineID = objSyncLib.saveAccountData(nNewZappCID,nOrderEntryCID,nWebHostingID,dRenewalDate,strUserName,strPassword,bActiveStatus,bDemoStatus,bUsedStatus,nCustomerProductID,nProductID,nYears)
			objSyncLib.setErrorResponse True
		Else
			objSyncLib.updateAccountData nOfflineID,nNewZappCID,nOrderEntryCID,nWebHostingID,dRenewalDate,strUserName,strPassword,bActiveStatus,bDemoStatus,bUsedStatus,nCustomerProductID,nProductID,nYears
			objSyncLib.setErrorResponse True
		End If	

		objSyncLib.CreateOfflineSyncLookup nOnlineID,nOfflineID,9,0,1
			
		objSyncLib.CreateXMLResponse True,strMessage,nNewZappCID,nOrderEntryCID
