...
<%
	...
	'getOrderEntryResponseCode = objSoapSync.SendSoap("", "http://system.newzapp.co.uk/status.html")
	'strResponseText = objSoapSync.getResponseText
	'set objSoapSync = Nothing
	'response.write getOrderEntryResponseCode
	'response.write "<br>this is the reponse" & strResponseText
...
Const SoapServerURL = "http://system.newzapp.co.uk"
