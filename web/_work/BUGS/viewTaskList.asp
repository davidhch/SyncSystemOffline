...
<table  border="0" cellspacing="0" cellpadding="0">
  <tr style="position:relative;  top:expression(this.offsetParent.scrollTop); ">
	...
	<div style="float:right;">TASK LIST</div>
	<a href="default.asp">HOME</a> | <a href="viewTaskList.asp">show all</a> | 
	
	<a href="viewTaskList.asp?ShowComplete=1">show completed</a> | 
	
	<a href="viewTaskList.asp?ShowComplete=0">show NOT completed</a>	</th>
  </tr>
 <tr style="position:relative;  top:expression(this.offsetParent.scrollTop); ">
...
set conn = Server.CreateObject("ADODB.Connection")
	...
	If Len(bShowComplete)> 0 Then
		If bShowComplete = 1 Then
			rs.Open "Select * from bugs WHERE bugType = 1 AND bugComplete = true ORDER BY bugSection, bugPriority, bugID ASC", conn
		End If
		If bShowComplete = 0 Then
			rs.Open "Select * from bugs WHERE bugType = 1 AND bugComplete <> true ORDER BY bugSection, bugPriority, bugID ASC", conn
		End If
	Else
		rs.Open "Select * from bugs WHERE bugType = 1 ORDER BY bugSection, bugPriority, bugID ASC", conn
	End If
	...
	do until rs.EOF
		...
		response.write  "<tr>"
			...
			response.write  "<td><div style=""width:200px;"">CID: "&bugCID&"<br> "& bugNotes &"</div><br><div style=""width:200px; color:#006699"">"& bugDevNotes &"</div></td>"
